...
export const examQuestionsUnit1: ExamQuestion[] = [
  ...
  },
  {
    id: 5,
    type: "open",
    question: "Use the stimulus and Table 1. If you were a policymaker, which packaging option would you recommend for sustainable food practices: teak leaves, paper, or plastic?\n\nExplain your reasoning using evidence about decomposition time, environmental impact, and food quality.\n\nWrite 3-5 sentences including: (1) recommendation, (2) at least two scientific reasons, and (3) comparison with another packaging option.",
    questionIdn: "Gunakan stimulus dan Tabel 1. Jika kamu menjadi pembuat kebijakan, kemasan mana yang kamu rekomendasikan untuk praktik pangan berkelanjutan: daun jati, kertas, atau plastik?\n\nJelaskan alasanmu menggunakan bukti tentang waktu terurai, dampak lingkungan, dan kemampuan menjaga kualitas makanan.\n\nTuliskan 3-5 kalimat yang memuat: (1) rekomendasi, (2) minimal dua alasan ilmiah, dan (3) perbandingan dengan kemasan lain.",
  },
];
...
export const examQuestionsUnit4: ExamQuestion[] = [
  ...
  },
  {
    id: 3,
    type: "checkbox",
    question: "When hot sand is used instead of cooking oil, oil absorption in crackers decreases.\nSelect TWO statements that best explain this scientifically.",
    questionIdn: "Ketika pasir panas digunakan sebagai pengganti minyak goreng, penyerapan minyak pada kerupuk berkurang.\nPilih DUA pernyataan yang paling tepat menjelaskan hal ini secara ilmiah.",
    options: [
      "Hot sand does not contain oil that can be absorbed by the cracker.",
      "Heat is transferred from the hot sand to the cracker through direct contact, without oil penetration.",
      "Hot sand increases the fat content of the cracker.",
      "Oil penetrates into the cracker during sand-frying.",
      "There is no contact between the cracker and the hot sand.",
    ],
    optionsIdn: [
      "Pasir panas tidak mengandung minyak yang dapat diserap oleh kerupuk.",
      "Panas berpindah dari pasir panas ke kerupuk melalui kontak langsung, tanpa penetrasi minyak.",
      "Pasir panas meningkatkan kandungan lemak pada kerupuk.",
      "Minyak masuk ke dalam kerupuk saat penggorengan dengan pasir.",
      "Kerupuk tidak bersentuhan dengan pasir panas.",
    ],
    correct: [
      "Hot sand does not contain oil that can be absorbed by the cracker.",
      "Heat is transferred from the hot sand to the cracker through direct contact, without oil penetration.",
...
export const examQuestionsUnit7: ExamQuestion[] = [
  ...
  },
  {
    id: 3,
    type: "mcq",
    question: "Compare the simulation results when community awareness is low and when community awareness is high. Increasing community awareness leads to improved fish population over time. Why does this happen?",
    questionIdn: "Bandingkan hasil simulasi ketika kesadaran masyarakat rendah dan ketika kesadaran masyarakat tinggi. Peningkatan kesadaran masyarakat menyebabkan populasi ikan membaik seiring waktu. Mengapa hal ini terjadi?",
    options: [
    ...
    optionsIdn: [
      ...
      "Hal ini mengurangi perilaku penangkapan berlebih dan mendukung pemanfaatan sumber daya laut yang lebih bertanggung jawab.",
  ...
  },
  {
    id: 4,
    type: "mcq",
    question: "Use the comparison below based on the simulation data.\n\nCommunity A:\n• Fishing intensity: High\n• Community awareness: Low\n• Result: Fish population declines\n\nCommunity B:\n• Fishing intensity: Medium\n• Community awareness: High\n• Result: Fish population is stable\n\nWhich conclusion best explains the difference?",
    questionIdn: "Gunakan perbandingan berikut berdasarkan data simulasi.\n\nKomunitas A:\n• Intensitas penangkapan ikan: Tinggi\n• Kesadaran masyarakat: Rendah\n• Hasil: Populasi ikan menurun\n\nKomunitas B:\n• Intensitas penangkapan ikan: Sedang\n• Kesadaran masyarakat: Tinggi\n• Hasil: Populasi ikan stabil\n\nKesimpulan manakah yang paling tepat menjelaskan perbedaan tersebut?",
    options: [
      "Community awareness can influence fishing behavior and marine sustainability.",
    ...
    optionsIdn: [
      "Kesadaran masyarakat dapat memengaruhi perilaku penangkapan ikan dan keberlanjutan laut.",
    ...
    correct: "Community awareness can influence fishing behavior and marine sustainability.",
  },
  {
    id: 5,
    type: "open",
    question: "The local government in Cirebon wants to improve marine sustainability. Write a short policy recommendation based on evidence from the simulation.\n\nYour recommendation should consider:\n• fishing intensity\n• community awareness\n• waste management\n• conservation efforts\n\nWriting guide: A strong answer proposes at least one specific policy action and explains how it can improve fish population, water quality, biodiversity, and sustainability.",
    questionIdn: "Pemerintah daerah di Cirebon ingin meningkatkan keberlanjutan laut. Tulislah rekomendasi kebijakan singkat berdasarkan bukti dari simulasi.\n\nRekomendasi kamu harus mempertimbangkan:\n• intensitas penangkapan ikan\n• kesadaran masyarakat\n• pengelolaan limbah\n• upaya konservasi\n\nPanduan penulisan: Jawaban yang kuat mengusulkan minimal satu tindakan kebijakan yang spesifik dan menjelaskan bagaimana tindakan tersebut dapat meningkatkan populasi ikan, kualitas air, keanekaragaman hayati, dan keberlanjutan.",
  },
];
