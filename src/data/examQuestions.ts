...
export const examQuestionsUnit3: ExamQuestion[] = [
  ...
  },
  {
    ...
    questionIdn: "Berdasarkan simulasi, kondisi mana yang tetap dapat menyebabkan efisiensi energi rendah meskipun menggunakan wadah tanah liat?",
    options: [
...
export const examQuestionsUnit4: ExamQuestion[] = [
  ...
  },
  {
    ...
    questionIdn: "Berdasarkan simulasi, kondisi mana yang dapat menghasilkan kerenyahan tinggi dengan penggunaan energi rendah atau sedang?",
    options: [
...
export const examQuestionsUnit5: ExamQuestion[] = [
  ...
  },
  {
    ...
    questionIdn: "Berdasarkan simulasi, kondisi mana yang menghasilkan rasa baik, keasaman sedang, dan daya simpan lebih lama?",
    options: [
