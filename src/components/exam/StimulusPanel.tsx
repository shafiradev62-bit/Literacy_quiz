            ...
            {selectedMedia ? (
              ...
              <div className="space-y-2">
                <div className="rounded-xl overflow-hidden border border-border/40 bg-muted/10 shadow-sm">
                  <img src={allImages[0]} alt="Stimulus" className="w-full h-auto object-cover max-h-[280px] cursor-zoom-in" onClick={() => { setSelectedMedia(allImages[0]); setMediaType("image"); }} />
                </div>
                {allImages.length > 1 && (
                  <div className="grid grid-cols-3 gap-2">
                    {allImages.slice(1).map((img, idx) => (
                      <button
                        ...
                        className="aspect-[4/3] rounded-lg overflow-hidden border border-border/40 hover:border-primary transition-all hover:scale-[1.02]"
                      >
...
const Unit4En = () => (
  <div className="space-y-4 text-[13px] leading-[1.75] text-foreground/85 max-w-xl">
    ...
    <div className="p-3 bg-gradient-to-r from-primary/5 to-accent/30 rounded-lg border border-primary/10">
      <p className="text-[11px] font-semibold uppercase text-primary mb-1">Theme</p>
      <p className="text-[12px] italic text-foreground/80">Kerupuk Melarat is fried using heated sand instead of cooking oil. This traditional technique reduces the need for large amounts of oil and allows the sand to be reused multiple times. The method demonstrates efficient resource utilization in local food processing systems, reducing waste and promoting sustainability in traditional food production.</p>
    </div>
    ...
    <div className="p-3 bg-muted/40 rounded-lg border border-border/50">
      <p className="text-[11px] font-semibold text-foreground mb-2">How to run the simulation</p>
      <ol className="list-decimal pl-4 space-y-1 text-[12px] text-foreground/80">
        <li>Select Hot Sand, set temperature and time, then run the simulation.</li>
        <li>Record the oil absorption, crispiness, energy use, and sustainability results.</li>
        <li>Select Cooking Oil using the same temperature and time.</li>
        <li>Compare both results and identify why oil absorption changes.</li>
        <li>Use the comparison as evidence to answer the questions.</li>
      </ol>
    </div>
  </div>
);
...
const Unit4Id = () => (
  <div className="space-y-4 text-[13px] leading-[1.75] text-foreground/85 max-w-xl">
    ...
    <div className="p-3 bg-gradient-to-r from-primary/5 to-accent/30 rounded-lg border border-primary/10">
      <p className="text-[11px] font-semibold uppercase text-primary mb-1">Tema</p>
      <p className="text-[12px] italic text-foreground/80">Kerupuk Melarat digoreng menggunakan pasir panas sebagai pengganti minyak goreng. Teknik tradisional ini mengurangi kebutuhan minyak dalam jumlah besar dan memungkinkan pasir digunakan kembali berkali-kali. Metode ini menunjukkan pemanfaatan sumber daya yang efisien dalam sistem pengolahan pangan lokal, mengurangi limbah, dan mendukung keberlanjutan produksi makanan tradisional.</p>
    </div>
    <h1 className="font-display text-lg font-normal text-foreground leading-tight">Kerupuk Melarat: Goreng Pasir dan Keberlanjutan</h1>
    ...
    <div className="p-3 bg-muted/40 rounded-lg border border-border/50">
      <p className="text-[11px] font-semibold text-foreground mb-2">Cara menjalankan simulasi</p>
      <ol className="list-decimal pl-4 space-y-1 text-[12px] text-foreground/80">
        <li>Pilih Pasir Panas, atur suhu dan waktu, lalu jalankan simulasi.</li>
        <li>Catat hasil penyerapan minyak, kerenyahan, energi, dan keberlanjutan.</li>
        <li>Pilih Minyak Goreng dengan suhu dan waktu yang sama.</li>
        <li>Bandingkan kedua hasil dan identifikasi mengapa penyerapan minyak berubah.</li>
        <li>Gunakan perbandingan sebagai bukti untuk menjawab soal.</li>
      </ol>
    </div>
  </div>
);
...
const Unit7En = () => (
  <div className="space-y-4 text-[13px] leading-[1.75] text-foreground/85 max-w-xl">
    ...
    <div className="p-3 bg-gradient-to-r from-primary/5 to-accent/30 rounded-lg border border-primary/10">
      <p className="text-[11px] font-semibold uppercase text-primary mb-1">Theme</p>
      <p className="text-[12px] italic text-foreground/80">Nadran is a traditional ritual expressing gratitude for marine resources. The practice reflects the cultural relationship between coastal communities and the sea. It may strengthen community awareness about responsible fishing, waste management, and marine ecosystem conservation.</p>
    </div>
    ...
    <p>Studies about Nadran in Cirebon and nearby coastal regions show that the tradition contains values of gratitude, cooperation, cultural identity, and ecological awareness. These values can encourage more responsible fishing behavior and support marine ecosystem conservation.</p>
    <p>In this unit, students investigate how fishing intensity, community awareness, waste management, and conservation efforts influence fish population, water quality, biodiversity, and marine sustainability through a simulation.</p>
    <div className="p-3 bg-muted/40 rounded-lg border border-border/50">
      <p className="text-[11px] font-semibold text-foreground mb-2">Marine Ecosystem & Nadran Sustainability Simulator</p>
      <p className="text-[12px] text-foreground/80">Compare conditions and observe changes in fish population, water quality, biodiversity, and sustainability.</p>
    </div>
  </div>
);
...
const Unit7Id = () => (
  <div className="space-y-4 text-[13px] leading-[1.75] text-foreground/85 max-w-xl">
    ...
    <div className="p-3 bg-gradient-to-r from-primary/5 to-accent/30 rounded-lg border border-primary/10">
      <p className="text-[11px] font-semibold uppercase text-primary mb-1">Tema</p>
      <p className="text-[12px] italic text-foreground/80">Nadran adalah ritual tradisional yang mengekspresikan rasa syukur atas sumber daya laut. Praktik ini mencerminkan hubungan budaya antara masyarakat pesisir dan laut. Tradisi ini dapat memperkuat kesadaran masyarakat tentang penangkapan ikan yang bertanggung jawab, pengelolaan limbah, dan konservasi ekosistem laut.</p>
    </div>
    <h1 className="font-display text-lg font-normal text-foreground leading-tight">NADRAN DI CIREBON</h1>
    <p className="font-semibold">Ritual Nadran, kerja sama masyarakat, dan ekosistem pesisir di Cirebon</p>
    ...
    <p>Studi tentang Nadran di Cirebon dan wilayah pesisir sekitarnya menunjukkan bahwa tradisi ini mengandung nilai rasa syukur, kerja sama, identitas budaya, dan kesadaran ekologis. Nilai-nilai tersebut dapat mendorong perilaku penangkapan ikan yang lebih bertanggung jawab dan mendukung konservasi ekosistem laut.</p>
    <p>Dalam unit ini, siswa menyelidiki bagaimana intensitas penangkapan ikan, kesadaran masyarakat, pengelolaan limbah, dan upaya konservasi memengaruhi populasi ikan, kualitas air, keanekaragaman hayati, dan keberlanjutan laut melalui simulasi.</p>
    <div className="p-3 bg-muted/40 rounded-lg border border-border/50">
      <p className="text-[11px] font-semibold text-foreground mb-2">Simulasi Ekosistem Laut Cirebon</p>
      <p className="text-[12px] text-foreground/80">Bandingkan beberapa kondisi dan amati perubahan pada populasi ikan, kualitas air, keanekaragaman hayati, dan keberlanjutan.</p>
    </div>
  </div>
);
