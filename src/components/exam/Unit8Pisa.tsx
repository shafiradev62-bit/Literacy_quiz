              ...
              <div className="space-y-5">
                ...
                <div className="bg-blue-50 border-2 border-blue-300 rounded-lg px-4 py-3 flex items-start gap-2">
                  ...
                  <div className="text-[11px] text-blue-800 leading-relaxed">
                    ...
                    <p className="mb-2">{isId ? "Kombinasi seimbang berarti variabel tidak harus semuanya tinggi atau semuanya sedang. Keseimbangan yang wajar biasanya menggunakan panen sedang, penanaman kembali lebih tinggi, dan pemanfaatan limbah lebih tinggi." : "A balanced combination means the variables are not simply all high or all medium. A reasonable balance usually uses moderate harvest, higher replanting, and higher waste utilization."}</p>
        ...
        <div className="flex-1 bg-white flex flex-col overflow-hidden transition-colors duration-500">
          <div className="p-6 h-full flex flex-col gap-5 overflow-y-auto exam-scrollbar">
            ...
            <div className="bg-white p-6 rounded-2xl border border-border/50 shadow-sm relative overflow-hidden group">
              ...
              <svg viewBox="0 0 510 240" className="w-full drop-shadow-sm" xmlns="http://www.w3.org/2000/svg">
                <defs>
