...
- Name: complete-units-1-10.spec.ts >> Complete Unit 1-10 Auto-Test with Screenshots >> Unit 1: Nasi Jamblang - Complete all questions
- Location: tests\complete-units-1-10.spec.ts:30:3
...
Call log:
  - waiting for locator('button').filter({ hasText: /Unit 1/i }).first()
